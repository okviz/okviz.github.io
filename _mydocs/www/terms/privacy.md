...
- **Personal Identification Data:** first name; last name; VAT Number; company name; physical address; country; state; city; ZIP/Postal code; email address.
- **User Account Data:** username; password; profile picture.
- **Organizational Data:** number of employees.
...
- **Tracking Data:** Trackers (e.g., Cookies and similar technologies).
