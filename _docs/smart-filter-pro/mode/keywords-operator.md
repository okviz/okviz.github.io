...
This options allows you to choose the logical operator to use in the query performed by Smart Filter Pro in Filter/Search mode.
...
You see that the logical operator AND satisfies both the specified filter conditions. So, the bar chart showing sales by date displays sales for the time period greater than or equal to 2017, and less than 2019.  
...
The ***Interactive*** option lets you to interactively switch between the AND and OR operators in the visual.
